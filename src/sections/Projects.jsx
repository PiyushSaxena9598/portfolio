...
export default function Projects() {
  ...
  const projects = useMemo(() => [
    {
      title: "MultiCart (E-Commerce Website)",
      link: "https://multicart-beta.vercel.app/",
      bgColor: "#0d4d3d",
      image: isMobile ? photo1 : img1,
    },
    {
      title: "ExamNotes Generator",
      link: "https://examnotesaiclient-rekp.onrender.com/auth",
      bgColor: "#3884d3",
      image: isMobile ? photo2 : img2,
    },
    {
      title: "Support AI (AI Chatbot)",
      link: "https://supportai-navy.vercel.app/",
      bgColor: "#dc9317",
            ...
            >
              <AnimatePresence mode="wait">
                {activeIndex === idx && (
                  <motion.h3
                    ...
                    className={`block text-center text-[clamp(2rem,6vw,5rem)] text-white/95 sm:absolute sm:-top-20 sm:left-[35%] lg:left-[-5%] sm:mb-0 italic font-semibold whitespace-nowrap ${
                      isMobile ? "-mt-24" : ""
                    }`}
                    style={{
                      zIndex: 5,
              ...
              >
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full h-full object-cover drop-shadow-xl md:drop-shadow-2xl mt-2"
                  style={{
                    position: "relative",
                    zIndex: 10,
