...
const socials = [
  {
    Icon: FaLinkedin,
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/piyush-saxena-16b8a4298/",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    link: "https://github.com/PiyushSaxena9598",
  },
  {
    Icon: TbBrandLeetcode,
    label: "LeetCode",
    link: "https://leetcode.com/u/Piyush_Saxena/",
  },
];
  ...
  return(
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">&copy; {new Date().getFullYear()} Piyush Saxena. All rights reserved.</p>
      </motion.div>
    </footer>
  )
}